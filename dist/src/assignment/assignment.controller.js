...
let AssignmentController = class AssignmentController {
    constructor(assignmentService, feedbackService) {
    ...
    async getPendingFeedback(user) {
        return this.feedbackService.getPendingFeedbackForUser(user.id);
    }
    async getFeedbackAggregate(user, courseId) {
        return this.feedbackService.getAdminAggregate(user.id, courseId);
    }
    async listFeedbackSubmissions(user, courseId, from, to, search, page, limit) {
    ...
    async getFeedbackSubmissionDetail(user, submissionId) {
...
__decorate([
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('cJwt')),
    (0, common_1.Get)('feedback/pending/me'),
    __param(0, (0, decorator_1.GetUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], AssignmentController.prototype, "getPendingFeedback", null);
__decorate([
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('cJwt')),
    (0, common_1.Get)('feedback/admin/aggregate'),
    __param(0, (0, decorator_1.GetUser)()),
    __param(1, (0, common_1.Query)('courseId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], AssignmentController.prototype, "getFeedbackAggregate", null);
__decorate([
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('cJwt')),
    ...
    __metadata("design:returntype", Promise)
], AssignmentController.prototype, "listFeedbackSubmissions", null);
__decorate([
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('cJwt')),
    (0, common_1.Get)('feedback/admin/:submissionId'),
    __param(0, (0, decorator_1.GetUser)()),
    __param(1, (0, common_1.Param)('submissionId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], AssignmentController.prototype, "getFeedbackSubmissionDetail", null);
__decorate([
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('cJwt')),
