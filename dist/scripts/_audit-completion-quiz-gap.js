...
async function main() {
  ...
  `;
    ...
    if (rows.length === 0) {
        ...
        for (const r of rows) {
            ...
            console.log(`    completedAt=${r.course_completed_at.toISOString()}  ` +
  ...
  `;
    ...
    for (const s of shape) {
        console.log(`${s.last_chapter_has_quiz ? '⚠️ ' : '  '} ${s.course_title}` +
...
//# sourceMappingURL=_audit-completion-quiz-gap.js.map