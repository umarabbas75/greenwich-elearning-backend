...
function buildPreviews() {
    ...
    const items = [
        ...
        {
            id: 'notification-forum-comment-direct',
            category: 'Notifications',
            name: 'Forum — reply to your comment',
            subject: '',
            trigger: 'Nested reply to the recipient’s comment',
            recipient: 'Student',
            render: () => (0, notification_template_1.renderNotificationEmail)({
                kind: 'FORUM_COMMENT',
                to: SAMPLE.email,
                ...
                threadTitle: 'Best practices for risk assessment',
                commenterName: 'Samira Khan',
                excerpt: 'That matches what we saw on site last week.',
                directReply: true,
            }).html,
        },
        {
            id: 'notification-forum-thread-pending',
            category: 'Notifications',
            name: 'Forum — awaiting review',
            subject: '',
            trigger: 'Student posted on a moderated board',
            recipient: 'Admin',
            render: () => (0, notification_template_1.renderNotificationEmail)({
                kind: 'FORUM_THREAD',
                to: 'admin@example.com',
        ...
        {
            id: 'notification-forum-answer-accepted',
            category: 'Notifications',
            name: 'Forum — marked as solution',
            subject: '',
            trigger: 'A reply was marked as the solution',
            recipient: 'Student',
            render: () => (0, notification_template_1.renderNotificationEmail)({
...
function getSubjectForId(id) {
    ...
    const map = {
        ...
        'notification-forum-comment-direct': (0, notification_template_1.renderNotificationEmail)({
            kind: 'FORUM_COMMENT',
            to: SAMPLE.email,
            recipientFirstName: SAMPLE.firstName,
            threadId: SAMPLE.threadId,
        ...
        'notification-forum-thread-pending': (0, notification_template_1.renderNotificationEmail)({
            kind: 'FORUM_THREAD',
            to: 'admin@example.com',
            recipientFirstName: 'Admin',
            threadId: SAMPLE.threadId,
        ...
        'notification-forum-answer-accepted': (0, notification_template_1.renderNotificationEmail)({
            kind: 'FORUM_ANSWER_ACCEPTED',
            to: SAMPLE.email,
            recipientFirstName: SAMPLE.firstName,
            threadId: SAMPLE.threadId,
        ...
        'notification-forum-mention': (0, notification_template_1.renderNotificationEmail)({
            kind: 'FORUM_MENTION',
            to: SAMPLE.email,
            recipientFirstName: SAMPLE.firstName,
            threadId: SAMPLE.threadId,
