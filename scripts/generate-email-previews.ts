...
function getSubjectForId(id: string): string {
  ...
  const map: Record<string, string> = {
    ...
    'notification-forum-comment-direct': renderNotificationEmail({
      kind: 'FORUM_COMMENT',
      to: SAMPLE.email,
      recipientFirstName: SAMPLE.firstName,
      threadId: SAMPLE.threadId,
    ...
    'notification-forum-thread-pending': renderNotificationEmail({
      kind: 'FORUM_THREAD',
      to: 'admin@example.com',
      recipientFirstName: 'Admin',
      threadId: SAMPLE.threadId,
    ...
    'notification-forum-answer-accepted': renderNotificationEmail({
      kind: 'FORUM_ANSWER_ACCEPTED',
      to: SAMPLE.email,
      recipientFirstName: SAMPLE.firstName,
      threadId: SAMPLE.threadId,
