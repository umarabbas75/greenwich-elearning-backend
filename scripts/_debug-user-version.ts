/**
 * One-off read: enrollment version pin for a user email + course title.
 *   yarn ts-node -r tsconfig-paths/register scripts/_debug-user-version.ts umartest@gmail.com test
 */
